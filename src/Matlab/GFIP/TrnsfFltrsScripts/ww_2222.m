...
if (gp==1) 
   ...
   if (prj==44)
      ...
      for k=1:m/4
         ...
         cc(2,k)=m-kkfour+3;
         cc(1,k+m/2)=kk2+m;
         cc(2,k+m/2)=m-kkfour+3;
         cc(1,k+m/4)=kk2+m/2;
         cc(2,k+m/4)=n-kkfour+3;
         cc(1,k+m/4+m/2)=kk2+m/2+m;
         cc(2,k+m/4+m/2)=n-kkfour+3;
      end   
   end   
   if (prj==45)
      dd=m*m-n+2;
      ...
      for k1=1:n/4-1
         ...
         for k2=0:m/2-1-k1
            kk2=2*k2;
            cc(1,1+k2+mk1)=kk2+1;
            cc(2,1+k2+mk1)=kkfour+1;
            kk2=2*k2+m;
            cc(1,k2+m/2+mk1)=kk2+1;
            cc(2,k2+m/2+mk1)=kkfour+1;
         end   
         for k2=m/2-1-k1+2:m/2-1
            kk2=2*k2;
            cc(1,k2+mk1)=kk2+1;
            cc(2,k2+mk1)=kkfour+1;
            kk2=2*k2+m;
            cc(1,k2-1+m/2+mk1)=kk2+1;
            cc(2,k2-1+m/2+mk1)=kkfour+1;
         end   
      end   
   end   
   if (prj==8)
