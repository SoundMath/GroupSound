...
% TODO % accomodate signals of different length
...
[u1,u2]=n_2(uu(:,1),gp);           % was: sdpt(uu(:,1),gp);
[v1,v2]=n_2(v(:,1),gp);            % was: sdpt(v(:,1),gp);
...
y=sqrt(n)*in_2(c,gp);                % was: sqrt(n)*isdpt(c,gp);
