...
%
for k=1:6
   x(1:n,1+(k-1)*n:k*n)=n*ifft2(x(1:n,1+(k-1)*n:k*n));
end   
bf=x;
%
for k=1:d3
...
for k=1:d3
   ...
   bf(c3(1,k),c3(2,k)+n3)=t3(2,k);
   bf(c3(1,k),c3(2,k)+n)=s3(1,k);
   bf(c3(1,k),c3(2,k)+n4)=s3(2,k);
   bf(c3(1,k),c3(2,k)+n2)=r3(1,k);
   bf(c3(1,k),c3(2,k)+n5)=r3(2,k);
   y3(c3(1,k),c3(2,k))=t3(1,k);
   y3(c3(1,k),c3(2,k)+n3)=t3(2,k);
   y3(c3(1,k),c3(2,k)+n)=s3(1,k);
   y3(c3(1,k),c3(2,k)+n4)=s3(2,k);
   y3(c3(1,k),c3(2,k)+n2)=r3(1,k);
   y3(c3(1,k),c3(2,k)+n5)=r3(2,k);
end
for k=1:d2
...
for k=1:d1
   ...
   bf(c1(1,k),c1(2,k)+n3)=t1(4,k);
   bf(c1(1,k),c1(2,k)+n4)=t1(5,k);
   bf(c1(1,k),c1(2,k)+n5)=t1(6,k);
   y1(c1(1,k),c1(2,k))=t1(1,k);
   y1(c1(1,k),c1(2,k)+n)=t1(2,k);
   y1(c1(1,k),c1(2,k)+n2)=t1(3,k);
   y1(c1(1,k),c1(2,k)+n3)=t1(4,k);
   y1(c1(1,k),c1(2,k)+n4)=t1(5,k);
   y1(c1(1,k),c1(2,k)+n5)=t1(6,k);
   y2(c1(1,k),c1(2,k))=0;
   y2(c1(1,k),c1(2,k)+n)=0;
   y2(c1(1,k),c1(2,k)+n2)=0;
   y2(c1(1,k),c1(2,k)+n3)=0;
   y2(c1(1,k),c1(2,k)+n4)=0;
   y2(c1(1,k),c1(2,k)+n5)=0;
   y3(c1(1,k),c1(2,k))=0;
   y3(c1(1,k),c1(2,k)+n)=0;
   y3(c1(1,k),c1(2,k)+n2)=0;
   y3(c1(1,k),c1(2,k)+n3)=0;
   y3(c1(1,k),c1(2,k)+n4)=0;
   y3(c1(1,k),c1(2,k)+n5)=0;
end   
y6=bf-y1-y2-y3;
