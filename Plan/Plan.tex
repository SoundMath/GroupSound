...
\noindent {\bf Short term goals/plans.}  (wjd: December 15, 2013)\\[5pt]
...
\vskip5mm
\noindent {\bf Initial thoughts on implementing this in Scala.}\\[5pt]
...
\begin{acronym}
\acro{GAP}{Group, Algorithms, and Programming}
\acro{XML}{Extensible Markup Language}
\acro{ICMC}{International Computer Music Conference}
\acro{ISMA}{International Symposium on Musical Acoustics}
\acro{NIME}{New Interfaces for Musical Expression}
